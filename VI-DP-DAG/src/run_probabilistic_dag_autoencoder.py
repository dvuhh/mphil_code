...
def run(
        ...
        pd_lr,  # Learning rate probabilistic model. float
    ...
    model = ProbabilisticDAGAutoencoder(input_dim=input_dim,
                                        ...
                                        pd_lr=pd_lr)
    # creates a unique identifier for each experiment configuration, making it easy to reproduce results later.
    ...
    t_start = time.time()
    train_losses, val_losses, train_nll, val_nll = train_autoencoder(model,
                                                                     train_loader,
                                                                     val_loader,
                                                                     max_epochs=max_epochs,
                                                                     frequency=frequency,
    ...
    return {**results, **metrics}, model, true_dag_adj
